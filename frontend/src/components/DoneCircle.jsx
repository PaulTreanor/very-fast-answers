...
export default function DoneCircle() {
  return (
    

    <div role="status">
        <svg aria-hidden="true" className="inline w-16 h-16 ml-1 text-gray-200 dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
